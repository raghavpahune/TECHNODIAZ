/**
 * Lightweight Standalone QRCode Generator for Technodiaz 2K26
 * Supports Canvas & SVG rendering with customizable colors and logo overlay.
 */
(function(root, factory) {
    ...
    function QRCode(element, options) {
        ...
        this.options = Object.assign({
            ...
            colorDark: "#000000",
            colorLight: "#ffffff",
            correctLevel: 2 // H (High error correction, allows logos in center)
        }, options);
    ...
    QRCode.prototype.makeCode = function(text) {
        this._oQRCode = new QRCodeModel(this.options.typeNumber, this.options.correctLevel);
    ...
    QRCode.prototype.getSvg = function() {
        ...
        for (var r = 0; r < count; r++) {
            for (var c = 0; c < count; c++) {
                if (this._oQRCode.isDark(r, c)) {
                    rects.push('<rect x="' + (c * tileW).toFixed(2) + '" y="' + (r * tileH).toFixed(2) + '" width="' + tileW.toFixed(2) + '" height="' + tileH.toFixed(2) + '" fill="' + this.options.colorDark + '"/>');
                }
            }
        }
        return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ' + width + ' ' + height + '" width="' + width + '" height="' + height + '">' +
               '<rect width="100%" height="100%" fill="' + this.options.colorLight + '"/>' +
               rects.join('') +
               '</svg>';
    };
